...
*Status: design proposal — phases 0–5 (the rules, the recursion, the Go
port, the CLI verbs, the deprecation mark, the default-validity lint)
are implemented. Per-phase status and the
