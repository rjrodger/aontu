...
5. **Counts of the shared suite live here and nowhere else.** All eight
   ...
   row-bearing, 4,636 rows**, in twenty-six modes — `canon` 876,
   ...
   `render` 34, `fmt-lint` 28, `diff` 28, `relation` 25, `hash` 21,
