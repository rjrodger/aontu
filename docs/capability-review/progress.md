...
5. **Counts of the shared suite live here and nowhere else.** All eight
   ...
   row-bearing, 4,693 rows**, in twenty-six modes — `canon` 876,
   `errc` 866, `gens` 779, `gen` 601, `err` 291, `view` 174, `fmt` 154,
   `errcode` 153, `subsume` 114, `vet` 100, `query` 92, `render` 87,
   ...
   profile rows beside them; earlier that day RENDER P2 added the membership rows
...
| [G9](g9-transformation.md) | Declarative transformation | D | 4 | 1 | 2 | 3 |
