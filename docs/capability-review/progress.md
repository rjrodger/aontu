...
5. **Counts of the shared suite live here and nowhere else.** All eight
   ...
   row-bearing, 4,595 rows**, in twenty-five modes — `canon` 876,
   `errc` 866, `gens` 776, `gen` 601, `err` 291, `view` 174, `fmt` 154,
   ...
   (Re-derived 2026-09-06, when RENDER P2 added the membership rows to
   six files; earlier that day the `aontu:` scheme and its two models
