...
carry: **none of the work below is in a released artifact.** npm
`aontu@0.52.1` and Go `go/v0.1.10` both predate the first review
commit. See [`status-2026-08-21.md`](status-2026-08-21.md#2-none-of-it-is-released).
