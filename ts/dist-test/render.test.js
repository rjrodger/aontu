...
(0, node_test_1.describe)('render-value', () => {
    ...
    (0, node_test_1.test)('render-profile-takes-no-options-and-fills-the-defaults', () => {
        const loaded = (0, render_1.renderProfile)('profile: lang: "text"');
        ...
        const refused = (0, render_1.renderProfile)('profile: lang: 1');
        node_assert_1.default.strictEqual(refused.profile, undefined);
        node_assert_1.default.strictEqual(refused.errors?.[0].path, '$.profile.lang');
    });
