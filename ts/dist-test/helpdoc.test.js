...
(0, node_test_1.describe)('helpdoc', () => {
    ...
    // this suite.
    (0, node_test_1.test)('the-tool-help-is-identical-in-both-ports', () => {
        ...
        Assert.equal(goText.slice(0, goText.indexOf('`')), tsText.slice(0, tsText.indexOf('`')), 'go/cmd/aontu/main.go helpText and ts/src/cli.ts HELP have drifted');
    });
