...
exports.NamerFuncVal = exports.NAMER_STYLES = void 0;
...
exports.NAMER_STYLES = NAMER_STYLES;
...
function styleName(name, style, acronyms) {
    ...
    if (CASENAME_STYLES.includes(style)) {
        return (0, lower_1.caseName)(src, style, acronyms);
    }
    if ('dot' === style) {
...
class NamerFuncVal extends FuncBaseVal_1.FuncBaseVal {
...
exports.NamerFuncVal = NamerFuncVal;
//# sourceMappingURL=NamerFuncVal.js.map