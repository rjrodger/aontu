...
(0, node_test_1.describe)('val-basic', function () {
    ...
    (0, node_test_1.it)('boolean', () => {
        ...
        (0, code_1.expect)(tu(ctx, bt, bf).isNil).exist();
        (0, code_1.expect)(tu(ctx, bf, bt).isNil).exist();
        (0, code_1.expect)(tu(ctx, bt, TOP)).equal(bt);
        (0, code_1.expect)(tu(ctx, bf, TOP)).equal(bf);
        (0, code_1.expect)(tu(ctx, TOP, bt)).equal(bt);
        (0, code_1.expect)(tu(ctx, TOP, bf)).equal(bf);
        ...
        (0, code_1.expect)(tu(ctx, bt, n0).isNil).exist();
        (0, code_1.expect)(tu(ctx, bf, n0).isNil).exist();
        (0, code_1.expect)(tu(ctx, n0, bt).isNil).exist();
        (0, code_1.expect)(tu(ctx, n0, bf).isNil).exist();
    ...
    (0, node_test_1.it)('string', () => {
        ...
        (0, code_1.expect)(tu(ctx, s0, s1).isNil).exist();
        (0, code_1.expect)(tu(ctx, s1, s0).isNil).exist();
        (0, code_1.expect)(tu(ctx, s0, TOP)).equal(s0);
        (0, code_1.expect)(tu(ctx, s1, TOP)).equal(s1);
        (0, code_1.expect)(tu(ctx, TOP, s0)).equal(s0);
        (0, code_1.expect)(tu(ctx, TOP, s1)).equal(s1);
        let b0 = new NilVal_1.NilVal('test');
        ...
        let n0 = makeNumberVal(1);
        (0, code_1.expect)(tu(ctx, s0, n0).isNil).exist();
        (0, code_1.expect)(tu(ctx, s1, n0).isNil).exist();
        (0, code_1.expect)(tu(ctx, n0, s0).isNil).exist();
        (0, code_1.expect)(tu(ctx, n0, s1).isNil).exist();
        (0, code_1.expect)(s0.same(s0)).equal(true);
        (0, code_1.expect)(new StringVal_1.StringVal({ peg: 'a' }).same(new StringVal_1.StringVal({ peg: 'a' }))).equal(true);
        (0, code_1.expect)(new StringVal_1.StringVal({ peg: 'a' }).same(new StringVal_1.StringVal({ peg: 'b' }))).equal(false);
    });
    (0, node_test_1.it)('number', () => {
        ...
        (0, code_1.expect)(tu(ctx, n0, n1).isNil).exist();
        (0, code_1.expect)(tu(ctx, n1, n0).isNil).exist();
        (0, code_1.expect)(tu(ctx, n0, n2).isNil).exist();
        (0, code_1.expect)(tu(ctx, n2, n0).isNil).exist();
        (0, code_1.expect)(tu(ctx, n1, n2).isNil).exist();
        (0, code_1.expect)(tu(ctx, n2, n1).isNil).exist();
        (0, code_1.expect)(tu(ctx, n0, TOP)).equal(n0);
        (0, code_1.expect)(tu(ctx, n1, TOP)).equal(n1);
        (0, code_1.expect)(tu(ctx, n2, TOP)).equal(n2);
        (0, code_1.expect)(tu(ctx, TOP, n0)).equal(n0);
        (0, code_1.expect)(tu(ctx, TOP, n1)).equal(n1);
        (0, code_1.expect)(tu(ctx, TOP, n2)).equal(n2);
        let b0 = new NilVal_1.NilVal('test');
        ...
        let s0 = new StringVal_1.StringVal({ peg: 's0' });
        (0, code_1.expect)(tu(ctx, n0, s0).isNil).exist();
        (0, code_1.expect)(tu(ctx, n1, s0).isNil).exist();
        (0, code_1.expect)(tu(ctx, n2, s0).isNil).exist();
        (0, code_1.expect)(tu(ctx, s0, n0).isNil).exist();
        (0, code_1.expect)(tu(ctx, s0, n1).isNil).exist();
        (0, code_1.expect)(tu(ctx, s0, n2).isNil).exist();
    ...
    (0, node_test_1.it)('number-unify', () => {
        ...
        n1.mark$ = 'n1';
        (0, code_1.expect)(n0.unify(n1, ctx).mark$).equal('n0');
        (0, code_1.expect)(n1.unify(n0, ctx).mark$).equal('n1');
        let tn0 = makeSK_Number();
        let ti0 = makeSK_Integer();
        (0, code_1.expect)(n0.unify(tn0, ctx).mark$).equal('n0');
        (0, code_1.expect)(tn0.unify(n0, ctx).mark$).equal('n0');
        (0, code_1.expect)(n0.unify(ti0, ctx).mark$).equal('n0');
        (0, code_1.expect)(ti0.unify(n0, ctx).mark$).equal('n0');
        let x0 = makeNumberVal(11);
        x0.mark$ = 'x0';
        let x1 = makeNumberVal(11);
        x1.mark$ = 'x1';
        (0, code_1.expect)(x0.unify(x1, ctx).mark$).equal('x0');
        ...
        (0, code_1.expect)(n0.unify(x0, ctx).mark$).equal('n0');
        let x2 = makeNumberVal(2.2);
        x2.mark$ = 'x2';
        (0, code_1.expect)(x2.unify(tn0, ctx).mark$).equal('x2');
        (0, code_1.expect)(tn0.unify(x2, ctx).mark$).equal('x2');
        (0, code_1.expect)(x2.unify(ti0, ctx).isNil).equal(true);
        (0, code_1.expect)(ti0.unify(x2, ctx).isNil).equal(true);
        (0, code_1.expect)(x2.unify(n0, ctx).isNil).equal(true);
    ...
    (0, node_test_1.it)('null', () => {
        ...
        (0, code_1.expect)(tu(ctx, nv, bv).isNil).exist();
        (0, code_1.expect)(tu(ctx, nv, mv).isNil).exist();
        (0, code_1.expect)(tu(ctx, nv, iv).isNil).exist();
        (0, code_1.expect)(tu(ctx, nv, sv).isNil).exist();
    });
    (0, node_test_1.it)('map', () => {
        ...
        (0, code_1.expect)(tu(ctx, m0, TOP).canon).equal('{}');
        (0, code_1.expect)(tu(ctx, TOP, m0).canon).equal('{}');
        let b0 = new NilVal_1.NilVal('test');
        (0, code_1.expect)(tu(ctx, m0, b0)).equal(b0);
        (0, code_1.expect)(tu(ctx, b0, m0)).equal(b0);
        let s0 = new StringVal_1.StringVal({ peg: 's0' });
        (0, code_1.expect)(tu(ctx, m0, s0).isNil).exist();
        (0, code_1.expect)(tu(ctx, s0, m0).isNil).exist();
        let n0 = makeNumberVal(0);
        (0, code_1.expect)(tu(ctx, m0, n0).isNil).exist();
        (0, code_1.expect)(tu(ctx, n0, m0).isNil).exist();
        let t0 = makeSK_String();
        (0, code_1.expect)(tu(ctx, m0, t0).isNil).exist();
        (0, code_1.expect)(tu(ctx, t0, m0).isNil).exist();
    ...
    (0, node_test_1.it)('conjunct', () => {
        ...
        (0, code_1.expect)(tu(ctx, P('1', d0), TOP).canon).equal('1');
        (0, code_1.expect)(tu(ctx, d0, P('2')).canon)
            .equal('nil');
        (0, code_1.expect)(tu(ctx, P('2'), d0).canon)
            .equal('nil');
        (0, code_1.expect)(tu(ctx, d0, TOP).canon).equal('1');
        (0, code_1.expect)(tu(ctx, TOP, d0).canon).equal('1');
        (0, code_1.expect)(tu(ctx, d1, TOP).canon).equal('1');
        (0, code_1.expect)(tu(ctx, TOP, d1).canon).equal('1');
        (0, code_1.expect)(tu(ctx, d2, TOP).canon)
            .equal('nil');
        (0, code_1.expect)(tu(ctx, TOP, d2).canon)
            .equal('nil');
        (0, code_1.expect)(tu(ctx, d3, TOP).canon).equal('1');
        (0, code_1.expect)(tu(ctx, TOP, d3).canon).equal('1');
        // TODO: term order is swapped by ConjunctVal impl - should be preserved
        (0, code_1.expect)(tu(ctx, d100, TOP).canon).equal('1');
    ...
    (0, node_test_1.it)('disjunct', () => {
        ...
        (0, code_1.expect)(tu(ctx, P('1|number'), TOP).canon).equal('1|number');
        (0, code_1.expect)(tu(ctx, P('1|top'), TOP).canon).equal('1|top');
        (0, code_1.expect)(tu(ctx, P('1|number|top'), TOP).canon).equal('1|number|top');
        (0, code_1.expect)(tu(ctx, P('1|number'), TOP).gen(ctx)).equal(1);
        (0, code_1.expect)(tu(ctx, P('1|number|top'), TOP).gen(ctx)).equal(1);
        (0, code_1.expect)(tu(ctx, P('number|1').unify(P('top'), ctx), TOP).canon).equal('number|1');
        (0, code_1.expect)(tu(ctx, P('1|number|1').unify(P('top'), ctx), TOP).canon).equal('1|number');
        (0, code_1.expect)(tu(ctx, P('number|string').unify(P('top'), ctx), TOP).canon)
            .equal('number|string');
        (0, code_1.expect)(tu(ctx, P('number|string').unify(P('1'), ctx), TOP).canon).equal('1');
        (0, code_1.expect)(tu(ctx, P('number|1').unify(P('1'), ctx), TOP).canon).equal('1');
        (0, code_1.expect)(tu(ctx, P('number|1').unify(P('number|1'), ctx), TOP).canon).equal('number|1');
        (0, code_1.expect)(tu(ctx, P('1|number').unify(P('1|number'), ctx), TOP).canon).equal('1|number');
        (0, code_1.expect)(tu(ctx, P('number|1').unify(P('1|number'), ctx), TOP).canon).equal('1|number');
        (0, code_1.expect)(tu(ctx, P('number|1').unify(P('number|string'), ctx), TOP).canon)
            .equal('number|1');
        (0, code_1.expect)(tu(ctx, P('number|string').unify(P('boolean|number'), ctx), TOP).canon)
            .equal('number');
        (0, code_1.expect)(tu(ctx, P('number|*1').unify(P('number|*1'), ctx), TOP).canon)
            .equal('number|1|*1');
        let u0 = tu(ctx, P('number|*1'), P('number'));
        (0, code_1.expect)(u0.canon).equal('number|1');
        (0, code_1.expect)(u0.gen(ctx)).equal(1);
        let u1 = tu(ctx, P('number|*1'), P('number|string'));
        (0, code_1.expect)(u1.canon).equal('number|1');
        (0, code_1.expect)(u1.gen(ctx)).equal(1);
        let u2 = tu(ctx, P('number|*1'), P('2'));
        (0, code_1.expect)(u2.canon).equal('2');
        (0, code_1.expect)(u2.gen(ctx)).equal(2);
    });
...
`);
    ...
    (0, node_test_1.it)('pref', () => {
        ...
        (0, code_1.expect)(p0.gen(ctx)).equal('p0');
        ...
        (0, code_1.expect)(up2s0.unify(new StringVal_1.StringVal({ peg: 's1' }), ctx).canon)
            .equal('nil');
