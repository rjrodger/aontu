...
(0, node_test_1.describe)('val-basic', function () {
    ...
    (0, node_test_1.it)('boolean', () => {
        ...
        (0, code_1.expect)(tu(ctx, bt, bf) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, bf, bt) instanceof NilVal_1.NilVal).exist();
        ...
        (0, code_1.expect)(tu(ctx, bt, n0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, bf, n0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n0, bt) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n0, bf) instanceof NilVal_1.NilVal).exist();
    ...
    (0, node_test_1.it)('string', () => {
        ...
        (0, code_1.expect)(tu(ctx, s0, s1) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, s1, s0) instanceof NilVal_1.NilVal).exist();
        ...
        let n0 = makeNumberVal(1);
        (0, code_1.expect)(tu(ctx, s0, n0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, s1, n0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n0, s0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n0, s1) instanceof NilVal_1.NilVal).exist();
    ...
    (0, node_test_1.it)('number', () => {
        ...
        (0, code_1.expect)(tu(ctx, n0, n1) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n1, n0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n0, n2) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n2, n0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n1, n2) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n2, n1) instanceof NilVal_1.NilVal).exist();
        ...
        let s0 = new val_1.StringVal({ peg: 's0' });
        (0, code_1.expect)(tu(ctx, n0, s0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n1, s0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n2, s0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, s0, n0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, s0, n1) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, s0, n2) instanceof NilVal_1.NilVal).exist();
    ...
    (0, node_test_1.it)('null', () => {
        ...
        (0, code_1.expect)(tu(ctx, nv, bv) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, nv, mv) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, nv, iv) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, nv, sv) instanceof NilVal_1.NilVal).exist();
    });
    (0, node_test_1.it)('map', () => {
        ...
        let s0 = new val_1.StringVal({ peg: 's0' });
        (0, code_1.expect)(tu(ctx, m0, s0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, s0, m0) instanceof NilVal_1.NilVal).exist();
        let n0 = makeNumberVal(0);
        (0, code_1.expect)(tu(ctx, m0, n0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, n0, m0) instanceof NilVal_1.NilVal).exist();
        let t0 = makeSK_String();
        (0, code_1.expect)(tu(ctx, m0, t0) instanceof NilVal_1.NilVal).exist();
        (0, code_1.expect)(tu(ctx, t0, m0) instanceof NilVal_1.NilVal).exist();
