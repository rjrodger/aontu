...
(0, node_test_1.describe)('unify', function () {
    ...
    (0, node_test_1.test)('multi-pass-ref-chain', () => {
        ...
        // 2-chain: 1 pass
        (0, code_1.expect)(G('a:$.b b:1')).equal({ a: 1, b: 1 });
        // 4-chain: 3 passes
        (0, code_1.expect)(G('a:$.b b:$.c c:$.d d:1')).equal({ a: 1, b: 1, c: 1, d: 1 });
        // 8-chain: 7 passes (exercises most of the 9-pass limit)
        (0, code_1.expect)(G('a:$.b b:$.c c:$.d d:$.e e:$.f f:$.g g:$.h h:1')).equal({ a: 1, b: 1, c: 1, d: 1, e: 1, f: 1, g: 1, h: 1 });
        // Verify via Unify that 8-chain actually needs 7 passes
        const u8 = new unify_1.Unify('a:$.b b:$.c c:$.d d:$.e e:$.f f:$.g g:$.h h:1', lang);
        (0, code_1.expect)(u8.cc).equal(7);
        (0, code_1.expect)(u8.res.done).equal(true);
        // 10-chain: 9 passes (hits the maximum, still converges)
        (0, code_1.expect)(G('a:$.b b:$.c c:$.d d:$.e e:$.f f:$.g g:$.h h:$.i i:$.j j:1')).equal({ a: 1, b: 1, c: 1, d: 1, e: 1, f: 1, g: 1, h: 1, i: 1, j: 1 });
    });
    (0, node_test_1.test)('multi-pass-nested-ref-chain', () => {
        ...
        (0, code_1.expect)(G('a:{v:$.b.v} b:{v:$.c.v} c:{v:$.d.v} d:{v:1}')).equal({ a: { v: 1 }, b: { v: 1 }, c: { v: 1 }, d: { v: 1 } });
        // 8-chain through nested paths: 7 passes
        const src8 = [
            'a:{v:$.b.v}', 'b:{v:$.c.v}', 'c:{v:$.d.v}', 'd:{v:$.e.v}',
            'e:{v:$.f.v}', 'f:{v:$.g.v}', 'g:{v:$.h.v}', 'h:{v:1}',
        ].join(' ');
        (0, code_1.expect)(G(src8)).equal({
    ...
    (0, node_test_1.test)('multi-pass-ref-with-spread', () => {
        ...
        (0, code_1.expect)(u6.cc).greaterThan(4);
        (0, code_1.expect)(u6.res.done).equal(true);
        // 4-ref chain + spread with concrete value
        (0, code_1.expect)(G('t:$.u u:$.v v:$.w w:1 m:{x:$.t}')).equal({ t: 1, u: 1, v: 1, w: 1, m: { x: 1 } });
        const u4 = new unify_1.Unify('t:$.u u:$.v v:$.w w:1 m:{x:$.t}', lang);
        (0, code_1.expect)(u4.cc).greaterThan(2);
        (0, code_1.expect)(u4.res.done).equal(true);
    });
});
