...
(0, node_test_1.describe)('lang', function () {
    ...
    (0, node_test_1.it)('merge', () => {
        ...
        (0, code_1.expect)(u0.gen()).equal({ a: { x: 1, y: 2 } });
        ...
        (0, code_1.expect)(u1.gen()).equal({ a: { b: { x: 1, y: 2 } } });
        ...
        (0, code_1.expect)(u2.gen()).equal({ a: { b: { c: { x: 1, y: 2 } } } });
        ...
        (0, code_1.expect)(u0m.gen()).equal({ a: { x: 1, y: 2, z: 3 } });
        ...
        (0, code_1.expect)(u1m.gen()).equal({ a: { b: { x: 1, y: 2, z: 3 } } });
        ...
        (0, code_1.expect)(u2m.gen()).equal({ a: { b: { c: { x: 1, y: 2, z: 3 } } } });
    });
    ...
    (0, node_test_1.it)('file', () => {
        ...
        (0, code_1.expect)(t00.res.gen()).equal({ a: 1 });
        ...
        (0, code_1.expect)(t00X.res.gen()).equal({ X: 11, a: 1 });
        ...
        (0, code_1.expect)(t00Y.res.gen()).equal({ Y: 22, a: 1 });
        ...
        (0, code_1.expect)(t00d.res.gen()).equal({ D: { a: 1 } });
