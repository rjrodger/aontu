...
const ScalarTypeVal_1 = require("./ScalarTypeVal");
class IntegerVal extends ScalarVal_1.ScalarVal {
    constructor(spec, ctx) {
        ...
        super({ peg: spec.peg, type: ScalarTypeVal_1.Integer }, ctx);
        this.isIntegerVal = true;
    }
    unify(peer, ctx) {
        if (null != peer) {
            if (peer.isScalarTypeVal && (peer.peg === Number || peer.peg === ScalarTypeVal_1.Integer)) {
                return this;
            }
