...
describe('val-ref', function () {
    test('construct', () => {
        ...
        let r1 = new RefVal_1.RefVal(['$', 'a', 'b']);
        // console.log(r0)
        ...
        let r5 = new RefVal_1.RefVal(['a', 'b']);
        // console.log(r0)
