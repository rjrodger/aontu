...
describe('val', function () {
    ...
    it('list-spread', () => {
        ...
        vals[val_1.ListVal.SPREAD] = { o: '&', v: P('{x:1}') };
        let l0 = new val_1.ListVal(vals);
    ...
    */
    ...
    it('disjunct', () => {
        let ctx = makeCtx();
        let d1 = new val_1.DisjunctVal([P('1'), P('2')]);
    ...
    it('ref', () => {
        let ctx = makeCtx();
        let d0 = new val_1.RefVal(['a']);
        let d1 = new val_1.RefVal(['c'], true);
        let d2 = new val_1.RefVal(['a', 'b'], false);
        let d3 = new val_1.RefVal(['c', 'd', 'e'], true);
  ...
  `, { xlog: -1 });
    ...
    it('pref', () => {
        let ctx = makeCtx();
        let p0 = new val_1.PrefVal(new val_1.StringVal('p0'));
        ...
        // expect(p0.gen([])).toEqual(undefined)
        let p1 = new val_1.PrefVal(new val_1.StringVal('p1'));
        let p2 = new val_1.PrefVal(new val_1.ScalarTypeVal(String));
