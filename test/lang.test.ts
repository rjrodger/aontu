...
describe('lang', function() {
  ...
  it('spreads', () => {
    ...
    expect(v0.canon).equal('{"a":{"b":{"y":1},"c":{"y":2}}&{&:"x":1,"y":integer}}')
  ...
  it('edge-top-spreads', () => {
    ...
    expect(v10.canon).equal('{"a":"b"}&{&:"b"&string}')
