...
dependedOnBy?: rel($.aontu.System.Service) & %CatalogAddr
```
...
The key is the predicate. `rel($.aontu.System.Service)` types every far end,
...
one catalog. Both views name the same `$.aontu.System.Service` and
